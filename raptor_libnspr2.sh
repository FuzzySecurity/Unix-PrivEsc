...
#
# $Id: raptor_libnspr2,v 1.6 2006/10/24 15:54:57 raptor Exp $
#
...
#
# Newschool version of local root exploit via LD_PRELOAD (hi KF!). Other
# possible (but less l33t;) attack vectors are: /var/spool/cron/atjobs,
# /root/.ssh/authorized_keys, /root/.bash{rc,_profile,logout}, /etc/rc?.d.
#
